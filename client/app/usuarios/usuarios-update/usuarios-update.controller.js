...
class UsuariosUpdateComponent {
  constructor(usuariosService, tipoDocumentoService, tipoContratoService, arlService, ciudadesService, epsService, pensionService, supervisorService, $state) {
  ...
  this.supervisorService.query().$promise
  .then(response =>{
